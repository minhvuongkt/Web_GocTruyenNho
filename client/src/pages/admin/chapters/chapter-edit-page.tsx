...
export default function ChapterEditPage({ contentId, chapterId }: { contentId: number, chapterId: number }) {
  ...
  const updateChapterMutation = useMutation({
    mutationFn: async (chapterData: any) => {
      const response = await apiRequest("PATCH", `/api/chapters/${chapterId}`, chapterData);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (content?.type === 'manga' && existingImages.length === 0 && chapterImages.length === 0) {
      toast({
        title: "Thiếu ảnh",
      ...
      <AdminLayout>
        <div className="flex items-center justify-center h-[500px]">
          <div className="flex flex-col items-center">
            ...
            <h2 className="mt-4 text-xl font-semibold">Không tìm thấy dữ liệu</h2>
    ...
    <AdminLayout>
      <div className="container mx-auto py-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Chỉnh sửa chương</h1>
            <p className="text-muted-foreground">
              {content.title} - Chương {chapter.number} - {content.type === 'manga' ? 'Truyện tranh' : 'Truyện chữ'}
            </p>
          </div>
          <div>
        ...
        <form onSubmit={handleSubmit}>
              ...
              {content.type === 'novel' ? (
                ...
                <div className="space-y-6">
                  ...
                  {existingImages.length > 0 && (
                    <div>
                      <h3 className="font-medium mb-3">Ảnh hiện tại ({existingImages.length})</h3>
                  ...
                  <Tabs defaultValue="image-upload">
                    <TabsList className="mb-4">
                      <TabsTrigger value="image-upload">Tải lên ảnh bổ sung</TabsTrigger>
                    ...
                    <TabsContent value="image-upload">
                      ...
                      {chapterImages.length > 0 && (
                        <div className="mt-6">
                          <h3 className="font-medium mb-2">Ảnh mới sẽ thêm ({chapterImages.length})</h3>
          ...
          <div className="mt-6 flex justify-end gap-4">
            ...
            >
              {(updateChapterMutation.isPending || uploadImagesMutation.isPending || processZipMutation.isPending) ? (
                <>
