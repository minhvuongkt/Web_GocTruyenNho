      ...
      <div className="container mx-auto py-6">
                  ...
                  {filteredChapters.length === 0 ? (
                      ...
                      <TableCell colSpan={6} className="text-center h-32">
                        {chaptersLoading ? (
                          ...
                          <div className="flex flex-col items-center justify-center h-full">
                            ...
                            <p>
                              Không tìm thấy chương nào phù hợp với "{search}"
                            </p>
                          </div>
                        ) : (
                          <div className="flex flex-col items-center justify-center h-full">
                            ...
                            <Button
                              className="mt-4"
                              onClick={() =>
                                navigate(`/admin/chapters/${contentId}/new`)
                              }
                            >
                              <Plus className="mr-2 h-4 w-4" />
                    ...
                    filteredChapters.map((chapter: any) => (
                      <TableRow key={chapter.id}>
                        ...
                        <TableCell>
                          <Link
                            href={`/truyen/${content.id}/chapter/${chapter.number}`}
                        ...
                        <TableCell>
                          <div className="flex justify-end items-center gap-2">
                            ...
                            <Button
                              ...
                              onClick={() =>
                                navigate(
                                  `/admin/chapters/${contentId}/chapter/${chapter.id}`,
                                )
                              }
                            >
        ...
        <Dialog open={showLockDialog} onOpenChange={setShowLockDialog}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>
                {selectedChapter?.isLocked ? "Mở khóa chương" : "Khóa chương"}
              </DialogTitle>
              <DialogDescription>
        ...
        >
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Hành động này không thể khôi phục. Chương và tất cả nội dung của
