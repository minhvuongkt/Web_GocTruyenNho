...
export interface IStorage {
  ...
  // External Ad management đã được gộp vào Advertisement
...
export class DatabaseStorage implements IStorage {
  ...
  // External Ad management methods đã được gộp vào Advertisement
  // Các phương thức này đã được loại bỏ và chuyển sang sử dụng Advertisement API với provider != 'internal'
